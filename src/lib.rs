...
//! package (CUDD). It uses version `3.0.0` of CUDD available from the unofficial
//! [Github mirror](https://github.com/ivmai/cudd) and compiles on Linux and MacOS
//! (you should be also able to build CUDD on Windows using cygwin, but the project is not set-up
